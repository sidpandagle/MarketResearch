...
export default function LatestReports() {
    ...
    return (<div className="max-w-6xl py-12 mx-auto md:pt-10 sm:px-6">
        <div className='mb-8 text-3xl font-extrabold text-center text-slate-600'>Latest Reports</div>
        <div className="flex items-center justify-between mt-6">
            ...
            >
                ...
                {['', '', '', '', '', '', '', '', '', '', '', ''].map((val, index) =>
                    <SwiperSlide key={index}>
                        <div className="ml-4 border rounded-md md:flex">
                            <div className="p-20 md:w-2/5 md:p-0 bg-slate-400 text-slate-400">
                                text
                            </div>
            ...
            <div className="ml-4" onClick={() => { my_swiper.slideNext() }}>
