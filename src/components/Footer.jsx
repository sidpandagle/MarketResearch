...
const Footer = () => {
  return (
    <>
      <footer className="relative flex justify-center z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            ...
            <LinkGroup header="Company">
              <NavLink link="/#" label="About Congruence" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-blue-400 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Congruence{" "}
                </p>
              </div>
            </div>
          </div>
