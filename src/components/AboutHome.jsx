    ...
    return (
      <div className='text-white bg-gradient '>
        <div className='max-w-6xl py-12 mx-auto md:pt-10 sm:px-6'>
          <div className="mb-8 text-3xl font-extrabold text-center ">About Us</div>
          <div className="items-center text-center md:text-left md:flex">
            <div className="md:w-1/2">
              ...
              <div className='flex flex-col gap-4 text-sm md:w-3/4'>
                <div className='px-8 md:p-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, exercitationem accusantium! </div>
                <div className='px-8 md:p-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, exercitationem accusantium! </div>
                <div className='px-8 md:p-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, exercitationem accusantium! </div>
                <div className='px-8 md:p-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, exercitationem accusantium! </div>
              </div>
