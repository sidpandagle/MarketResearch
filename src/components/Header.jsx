          ...
          <div className="relative flex items-center justify-between mx-4">
            ...
            <div className="flex items-center justify-end w-full px-4">
              <div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-menu-2" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
