...
export default function BuyNowForm({ onSubmit }) {
    return (
        <section className="">
            <div className="">
                <div className='text-center text-xl font-semibold pb-8'>Buy Now Form</div>
                <form action="#">
                    ...
                    <div className='flex justify-center'>
                        <button type="button" onClick={onSubmit} className="inline-flex items-center justify-center gap-2 px-8 py-2 mt-6 text-sm font-semibold text-white transition-all bg-indigo-500 border border-transparent rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-2">
                            Submit
                        </button>
                    </div>
                </form>
